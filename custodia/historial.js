...
(() => {
    ...
    const urlLoad = BASE_URL + 'TerminalCalama/PHP/Custodia/load.php';
    const urlLoadRut = BASE_URL + 'TerminalCalama/PHP/Custodia/load_rut.php';

    console.log('✅ Custodia Hist config loaded:', {
        environment: ENV,
        baseURL: BASE_URL,
        urlLoad: urlLoad,
        urlLoadRut: urlLoadRut
    });
